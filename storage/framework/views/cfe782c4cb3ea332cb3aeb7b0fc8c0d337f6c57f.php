        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills" data-toggle="tabs">
                    ...
                    <li class="nav-item"><a class="nav-link"  href="#banner" data-toggle="tab"><i class="fa fa-fw fa-mobile"></i> <?php echo e(__lang('smart-banners')); ?></a></li>
                </ul>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vuu0eqn78jhj/public_html/syncify.us/resources/views/admin/setting/index.blade.php ENDPATH**/ ?>