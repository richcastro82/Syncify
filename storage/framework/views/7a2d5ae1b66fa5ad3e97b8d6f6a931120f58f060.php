                        ...
                        <?php endif; ?>
                            ...
                            <ul class="team-social">
                                <?php if(!empty($admin->social_facebook)): ?>
                                    <li><a  href="<?php echo e($admin->social_facebook); ?>"><i class="fab fa-facebook-f"></i></a></li>
                                <?php endif; ?>

                                <?php if(!empty($admin->social_twitter)): ?>
                                        <li><a  href="<?php echo e($admin->social_twitter); ?>"><i class="fab fa-twitter"></i></a></li>
                                <?php endif; ?>

                                <?php if(!empty($admin->social_linkedin)): ?>
                                        <li><a  href="<?php echo e($admin->social_linkedin); ?>"><i class="fab fa-linkedin"></i></a></li>
                                <?php endif; ?>

                                <?php if(!empty($admin->social_instagram)): ?>
                                        <li><a  href="<?php echo e($admin->social_instagram); ?>"><i class="fab fa-instagram"></i></a></li>
                                <?php endif; ?>

                                <?php if(!empty($admin->social_website)): ?>
                                        <li><a  href="<?php echo e($admin->social_website); ?>"><i class="fas fa-globe"></i></a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
...
<?php echo $__env->make(TLAYOUT, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vuu0eqn78jhj/public_html/syncify.us/public/templates/education/views/site/home/index.blade.php ENDPATH**/ ?>