            ...
            <div class="panel-body">
                ...
                <div class="media media-clearfix-xs">
                    ...
                    <div class="media-body">
                        <h4 class="text-headline margin-v-5-0"><a href="{{  $this->url('course-details',['id'=>$row->session_id,'slug'=>safeUrl($row->session_name)]) }}">{{  $row->session_name  }}</a></h4>
                        ...
                        <a href="{{  $this->url('course-details',['id'=>$row->session_id,'slug'=>safeUrl($row->session_name)]) }}" class="btn btn-primary float-right"><i class="fa fa-info-circle"></i> {{  __lang('details')  }}</a>
    ...
    <div class="col-md-3">
        ...
        <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            <div class="panel-heading panel-collapse-trigger">
                <h4 class="panel-title">{{  __lang('category')  }}</h4>
            </div>
            <div class="panel-body list-group">
                <ul class="list-group">
                    <li class="list-group-item">
                        <a class="list-group-link" href="{{  $this->url('courses')  }}">{{  __lang('all-courses')  }}</a>
                    </li>

                    @php  foreach($categories as $category): @endphp
                    <li class="list-group-item">
                        <a class="list-group-link" href="{{  $this->url('courses')  }}?group={{  $category->session_category_id  }}">{{  $category->category_name }}</a>
                    </li>
                    @php  endforeach;  @endphp
                </ul>
            </div>
        ...
        <div class="panel panel-default" data-toggle="panel-collapse" data-open="false">
            ...
            <div class="panel-body">
                <form id="filterform" class="form" role="form"  method="get" action="{{  $this->url('courses') }}">
